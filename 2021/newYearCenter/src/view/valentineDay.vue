    ...
    <div class="valentineDay-wrap">
        ...
        <div class="list-container">
            ...
            <div class="myinfo">
                ...
                <List v-if="selfInfo.length > 0" :titles="isAnchor?anchorListTitle:userListTitle"
                      :list="selfInfo"></List>
        ...
        .awardContainer {
            ...
            .valentineGift-wrap {
                ...
                .valentineGift {
                    ...
                    width: 522px;
                    height: 302px;
                    background-image: url("../assets/img/medalAward.png");
            ...
            .medal-wrap {
                ...
                .valentineMedal {
                    ...
                    width: 924px;
                    height: 316px;
                    background-image: url("../assets/img/valentineMedal.png");
                    background-size: 100% 100%;
                }
                ...
                .loveMedal-wrap {
                    ...
                    .loveMedal {
                        ...
                        width: 921px;
                        height: 217px;
                        background-image: url("../assets/img/loveOnelife.png");
                    }
