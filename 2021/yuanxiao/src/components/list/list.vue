            ...
            <div class="list-content">
                <ul class="list">
                    <li class="item" v-for="(item,index) in list">
                        <div class="rank">
                            <div class="rankimg" :class="item.rankNo < 4 ? 'rankimg'+(index+1) : '' ">{{index+1}}</div>
                        </div>
                        <div class="name">
                ...
                .item {
                    ...
                    .rank {
                        ...
                        .rankimg1 {
                            color: #ff6e04;
                            line-height: 47px;
                            background-image: url("../../assets/img/listNo1.png");
                        }

                        .rankimg2 {
                            color: #6f6f6f;
                            line-height: 47px;
                            background-image: url("../../assets/img/listNo2.png");
                        }

                        .rankimg3 {
                            color: #982a0d;
                            line-height: 47px;
                            background-image: url("../../assets/img/listNo3.png");
                        }
                    }
